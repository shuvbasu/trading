...
#For Constrained Least squares optimization
...
All_G8 = ['EUR_USD','EUR_GBP','EUR_JPY','EUR_AUD','GBP_USD','GBP_JPY','GBP_AUD','AUD_USD','USD_JPY','AUD_JPY','GBP_CAD'
          ,'CAD_JPY','EUR_CAD','AUD_CAD','USD_CAD','BCO_USD','WTICO_USD','XAU_USD', 'XAG_USD', 'NZD_USD', 'NZD_JPY', 'GBP_NZD', 'EUR_NZD', 
          'GBP_CHF', 'EUR_CHF','USD_CHF','AUD_CHF','NZD_CAD','AUD_NZD','SPX500_USD','USB10Y_USD',
          'USB02Y_USD','USB05Y_USD','UK100_GBP','UK10YB_GBP','DE30_EUR','DE10YB_EUR'
          ]
CCY_Tester = ['USD_CAD','AUD_USD']
# No. of Candles setup
...
for gran in ['W','D','H4']:
    ...
    #                          
        ...
        data1D = oanda.get_history(instrument=curr,  # our instrument
                                 ...
                                 # end = '2018-04-13',
                                 # end=enddate.strftime('%Y-%m-%d'),  # end date i.e current date
                                 granularity=gran) 
...
#                 plt.plot(xfit,yfit)
    ...
    #         plt.title(curr + "  " + gran)
                ...
                plt.savefig('C:\Users\Shuv\Documents\All Trading\Program Outputs\TestRuns\%s' % curr + "_" + gran)
                plt.close()
